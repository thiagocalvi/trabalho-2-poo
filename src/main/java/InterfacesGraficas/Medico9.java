 ...
 * @author matheus
 */
public class Medico9 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Medico9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
