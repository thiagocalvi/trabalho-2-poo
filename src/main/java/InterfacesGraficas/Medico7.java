 ...
 * @author matheus
 */
public class Medico7 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Medico7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
