 ...
 * @author matheus
 */
public class Medico8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Gerar atestado médico");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Medico8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
